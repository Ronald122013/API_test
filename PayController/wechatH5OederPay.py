...
class wechatH5OederPay(unittest.TestCase):
    def setUp(self):
    ...
    def test_wechatH5OederPay(self):
        self.url = domain + '/toBRegister'
        self.headers = {"Content-Type":"application/json;charset=UTF-8"}
        with open('./PayController/wechatH5OederPay.json','r',encoding='utf-8') as f:
            data = json.load(f)
        self.form = data
        #print(data)   #调试用
...
if __name__ == '__main__':
    #unittest.main()
    runTest = wechatH5OederPay()
    runTest.test_wechatH5OederPay()
