...
class appRegisterForSmallB(unittest.TestCase):
    def setUp(self):
    ...
    def test_appRegisterForSmallB(self):
        self.url = domain + '/toBRegister'
        self.headers = {"Content-Type":"application/json;charset=UTF-8"}
        with open('./LoginController/appRegisterForSmallB.json','r',encoding='utf-8') as f:
            data = json.load(f)
        self.form = data
        #print(data)   #调试用
...
if __name__ == '__main__':
    #unittest.main()
    runTest = appRegisterForSmallB()
    runTest.test_appRegisterForSmallB()
